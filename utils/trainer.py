...
class Trainer():
    ...
    #
    #     y_hat = self.model(features['feat_l'], is_training)
    #
    #     return y_hat
    ...
    #     self.is_small = not ('1' in self.model_name)
    #     # Baseline Models
    #     if self.model_name == 'simple' or self.model_name == 'simpleA':  # Baseline  No High Res for training
    #         earlyl = self.feat_l
    #         if self.model_name == 'simpleA':
    ...
    #                                         return_feat=True)
    #
    #     elif 'simpleA' in self.model_name:
    #
    #         depth = int(self.model_name.replace('simpleA', ''))
    #         earlyl = semi.encode_same(self.feat_l, is_training=self.is_training, is_bn=True, is_small=self.is_small)
    #         self.y_hat, mid, latel = simple(earlyl, n_classes=self.n_classes, is_training=self.is_training,
    #                                         return_feat=True, deeper=depth)
    #     elif 'dropoutsimpleA' in self.model_name:
    #
    #         depth = int(self.model_name.replace('dropoutsimpleA', ''))
    #         earlyl = semi.encode_same(self.feat_l, is_training=self.is_training, is_bn=True, is_small=self.is_small)
    #         self.y_hat, mid, latel = simple(earlyl, n_classes=self.n_classes, is_training=self.is_training,
    #                                         return_feat=True, deeper=depth)
    #     elif self.model_name == 'count':
    #         self.y_hat = countception(self.feat_l,pad=self.pad, is_training=self.is_training, config_volume=self.config)
    #
    #     elif self.model_name == 'countA':
    #
    #         earlyl = semi.encode_same(self.feat_l, is_training=self.is_training, is_bn=True, is_small=self.is_small)
    ...
    #
    #     else:
    #         raise ValueError('Model {} not defined'.format(self.model_name))
    ...
    def compute_summaries_old(self):
