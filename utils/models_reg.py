...
class Block(layers.Layer):
    def __init__(self, nfeatures = [64,64,256], is_dropout=False):
        ...
        if self.is_dropout:
            self.dropout1 = layers.Dropout(rate=0.5, noise_shape=(None, 1,1, nfeatures[0]))
            self.dropout2 = layers.Dropout(rate=0.5, noise_shape=(None, 1,1, nfeatures[1]))
            self.dropout3 = layers.Dropout(rate=0.5, noise_shape=(None, 1,1, nfeatures[2]))
